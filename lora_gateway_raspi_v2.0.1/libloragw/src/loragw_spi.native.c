...
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
extern struct lgw_conf_board_s board_conf;
/* Simple write */
int lgw_spi_w(void *spi_target, uint8_t spi_mux_mode, uint8_t spi_mux_target, uint8_t address, uint8_t data) {
    ...
    if(spi_mux_mode == LGW_SPI_MUX_MODE2) {
    	lgw_spi_cs(spi_mux_target,0);
    }
    a = ioctl(spi_device, SPI_IOC_MESSAGE(1), &k);
    if(spi_mux_mode == LGW_SPI_MUX_MODE2) {
    	lgw_spi_cs(spi_mux_target,1);
    }
    /* determine return code */
    if (a != (int)k.len) {
...
void lgw_spi_cs(uint8_t target, int8_t sel) {

	if(board_conf.pin_CS[target] > 0) {
		if(sel <= 0) {
			digitalWrite(board_conf.pin_CS[target],0);
		} else {
			digitalWrite(board_conf.pin_CS[target],1);
		}
	}
	/*
	else {
		if(sel <= 0) {
			...
			switch (target){
				case 0:a0 = 1; a1= 0; a2 = 0; a3 = 1;break;
				case 1:a0 = 0; a1= 0; a2 = 0; a3 = 1;break;
				case 2:a0 = 1; a1= 1; a2 = 1; a3 = 0;break;
				case 3:a0 = 0; a1= 1; a2 = 1; a3 = 0;break;
				case 4:a0 = 1; a1= 0; a2 = 1; a3 = 0;break;
				case 5:a0 = 0; a1= 0; a2 = 1; a3 = 0;break;
				case 6:a0 = 1; a1= 1; a2 = 0; a3 = 0;break;
				case 7:a0 = 0; a1= 1; a2 = 0; a3 = 0;break;
				case 8:a0 = 1; a1= 0; a2 = 0; a3 = 0;break;
				case 9:a0 = 0; a1= 0; a2 = 0; a3 = 0;break;
				default:a0 = 1; a1= 1; a2 = 1; a3 = 1;
			}
			digitalWrite(board_conf.pins_csDec[0],a0);
			digitalWrite(board_conf.pins_csDec[1],a1);
			digitalWrite(board_conf.pins_csDec[2],a2);
			digitalWrite(board_conf.pins_csDec[3],a3);

		} else {
			digitalWrite(board_conf.pins_csDec[0],1);
			digitalWrite(board_conf.pins_csDec[1],1);
			digitalWrite(board_conf.pins_csDec[2],1);
			digitalWrite(board_conf.pins_csDec[3],1);
		}
	}
	*/
}
